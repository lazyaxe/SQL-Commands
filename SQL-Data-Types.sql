...
(
	...
	ID SERIAL,--Auto updates/increment by one itself, and is optional to provide value
	age SMALLINT, 
	price NUMERIC(6, 2),--NUMERIC(p, n) where p is the digit limit and n is floating point limit
	percent DECIMAL(4, 2),--Same as the NUMERIC
	is_true BOOL,
	rating REAL
);
